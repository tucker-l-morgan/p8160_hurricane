...
$$\pi(\boldsymbol{\beta} \mid \textbf{B}, \sigma^2, \Sigma, Y_i) = \frac{\pi(\beta, \textbf{B},\sigma^2, \Sigma \mid Y_i)}{\pi(\textbf{B}, \sigma^2, \Sigma)}.$$
...
$$\pi(\boldsymbol{\beta} \mid \textbf{B}, \sigma^2, \Sigma, Y_i) \propto ...$$
