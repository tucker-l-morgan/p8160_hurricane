...
B_est2 <- Reduce("+", B_res_list[901:1000]) / length(B_res_list[901:1000])
...
speed_month <- df_month %>% 
               ...
               pivot_longer(max:start,
                            names_to = 'speed_type',
                            values_to = 'speed')
ggplot(beta_month, aes(x = month, y = beta_value, color = beta)) + geom_smooth(se = F)
ggplot(speed_month, aes(x = month, y = speed, color = speed_type)) + geom_smooth(se = F)
...
speed_year <- df_year %>% 
               ...
               pivot_longer(max:start,
                            names_to = 'speed_type',
                            values_to = 'speed')
ggplot(beta_year, aes(x = year, y = beta_value, color = beta)) + geom_smooth(se = F)
ggplot(speed_year, aes(x = year, y = speed, color = speed_type)) + geom_smooth(se = F)
